...
class CandlestickDatasetTest {
    ...
    void findCandlestickMinTest() {
        ...
        assertEquals(cds.getMinValue(), cds.findMin());

        cds.addValue(new Candlestick("2",1,1,-2,1));

        assertEquals(-2, cds.findMin());
        assertEquals(cds.getMinValue(), cds.findMin());
    ...
    void findCandlestickMaxTest() {
        ...
        assertEquals(cds.getMaxValue(), cds.findMax());

        cds.addValue(new Candlestick("2",1,14,-2,1));

        assertEquals(14, cds.findMax());
        assertEquals(cds.getMaxValue(), cds.findMax());
    }
}